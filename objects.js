...
let vehicel = person5.possessionCategories[1].list[1].model
console.log(vehicel)
// 2.5b
...
let furnitureColor = person5.possessionCategories[0].list[0].color
console.log(furnitureColor)

// 2.5d
//  whether or not person5 has any outstanding warrants,

let warrant = person5.hasOutstandingWarrants
