...
let dog = new Animal(85, true, `brown`)
...
let snakeWeight = snake.weightinLbs

console.log(dog)
console.log(snake)
console.log(`The dog's weight is ${dogWeight}`)
...
class Dog extends Animal {
    constructor(weightinLbs, primaryColor,name, breed, heightAtWithersInInches ){
...
let oscar = new Dog(85, `brown`, `Oscar`, `golden`, 20)
let champ = new Dog(200, `black`, `Champ`, `mastiff`, 45)
let roy = new Dog(12, `golden`,`roy`, `weenie`, 3)
// 2.3
