...
let funcExpression = function (){
    console.log(`my function was invoked once again!`)
}
...
const funcArrow = () => console.log(`my function has been invoked in a one line arrow expresion`)
...
let myArr = [addFifty(20), addFifty(30), addFifty(50)]
console.log(myArr)
