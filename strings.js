...
// removes the whitespace from both ends of a string and returns a new shallow copy  of the string 
...
let myString = `I love to eat apples and bananas`
let newSTr = myString.replaceAll(`a`, `u`)
console.log(newSTr)
